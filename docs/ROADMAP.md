...
- Running and debuggin apps
  ...
  - error handling - how to configure http response to configure error. how to
    report error from controller (see strong-error-handler)
- project layout reference
  https://loopback.io/doc/en/lb3/Project-layout-reference.html
...
- Articles/materials that can help more users adopting LoopBack 4
  ...
  - write an article about what LB can offer on top of Express
  - Write an article/docs on "from API to UI: LoopBack + Angular" - using client
    generator
  - write an article about LB + TypeORM/Sequelize/Mongoose/Prisma
