...
_Scope_ enables you to specify commonly-used queries that you can reference as method calls on a model.
...
<table>
  ...
  <tbody>   
    <tr>
      ...
      <td>No</td>
      <td>Boolean</td>
      <td><strong>For auto-migrate usage</strong>. The <code>generated</code> property indicates the ID will be automatically generated by the database. When it sets to <code>true</code>, the value of the id property will be generated by the database automatically with its default type (e.g integer for MySQL and string for MongoDB).</td>
    </tr>
    <tr>
